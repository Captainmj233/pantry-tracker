...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <Typography variant="h5" color="#8bc34a" textAlign="center" mb={4}>
      ...
      >
        ...
        >
          <Typography variant="h5" color="#555" textAlign="center" sx={{ width: '30%' }}>
            Item
          </Typography>
          <Typography variant="h5" color="#555" textAlign="center" sx={{ width: '30%' }}>
            Quantity
        ...
        {filteredInventory.map(({ name, quantity }) => (
          <Box
            ...
            sx={{
              bgcolor: quantity > 3 ? '#d4edda' : '#f8d7da',
            }}
          >
            <Typography variant="h6" color="#333" sx={{ width: '40%' }}>
              {name.charAt(0).toUpperCase() + name.slice(1)}
            </Typography>
            <Typography variant="h6" color="#333" textAlign="center" sx={{ width: '20%' }}>
              {quantity}
            </Typography>
